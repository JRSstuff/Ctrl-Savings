<script>
  ...
  // Show floating bubble if not installed, not dismissed for current session, and app is loaded
  let showInstallBubble = $derived(!isInstalled && !isDismissed && appLoaded)
